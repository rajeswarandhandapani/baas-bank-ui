...
export const KEYCLOAK_BASE_URL = 'http://localhost:18089/realms/baas';
...
export const BACKEND_MODE: 'orchestrated' | 'choreographed' = 'choreographed';
export const PAYMENT_ENDPOINT = '/api/payments';
export const ONBOARDING_ENDPOINT = '/api/users';
