import { PAYMENT_ENDPOINT } from '../../../core/config/app.constants';
...
export class PaymentService {
   ...
   */
  createPayment(payment: CreatePaymentRequest): Observable<string> {
    return this.http.post(PAYMENT_ENDPOINT, payment, {
      responseType: 'text',
    });
  }
