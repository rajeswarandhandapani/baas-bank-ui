...
export class ChatService {
  ...
  private messagesSubject = new BehaviorSubject<ChatMessage[]>([
    {
      sender: 'bot',
      text: 'Welcome to BaaS Bank. How can I help you today? I can help with viewing your BAAS Bank accounts, transactions, payments, and notifications',
    },
  ]);
  ...
  send(text: string) {
    ...
    this.http
      .post<string>(`${this.baseUrl}/chat`, null, {
        params,
